    ...
    return (
        ...
        >
            <div className="relative">
                {/* Círculo pulsante */}
                <span className="absolute inline-flex h-44 w-44 rounded-full bg-[#25D366] opacity-75 animate-ping" />

                {/* Botón principal */}
                <div className="relative w-32 h-32 rounded-full bg-[#25D366] shadow-xl flex items-center justify-center hover:scale-105 transition-transform">
                    <svg
